...
Saved .html file
↓Unraid input folder
↓Docker watcher sees the file
↓HTML is cleaned and converted
↓EPUB is split into smaller internal parts
↓EPUB goes to Calibre ingest folder
↓Calibre automatically imports it
↓Book appears through OPDS
↓Xteink X4 / CrossPoint reader downloads it
```
